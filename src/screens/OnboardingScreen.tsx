...
const OnboardingScreen = () => {
	...
	const onboardingData: OnboardingSlide[] = [
		{
			id: '1',
			title: t('onboarding_screen.welcome_title'),
			subtitle: t('onboarding_screen.welcome_subtitle'),
			description: t('onboarding_screen.welcome_desc'),
		},
		{
			id: '2', //addons
			title: t('onboarding_screen.addons_title'),
			subtitle: t('onboarding_screen.addons_subtitle'),
			description: t('onboarding_screen.addons_desc'),
		},
		{
			id: '3', // discovery
			title: t('onboarding_screen.discovery_title'),
			subtitle: t('onboarding_screen.discovery_subtitle'),
			description: t('onboarding_screen.discovery_desc'),
		},
		{
			id: '4', // library
			title: t('onboarding_screen.library_title'),
			subtitle: t('onboarding_screen.library_subtitle'),
			description: t('onboarding_screen.library_desc'),
		},
	];
			...
			<View style={styles.fullScreenContainer}>
				...
				>
					...
					<View style={styles.footerButtonContainer}>
						...
						<Animated.View
							style={[styles.swipeIndicator, styles.absoluteFill, swipeOpacityStyle]}
						>
							<Text style={styles.swipeText}>
								{t('onboarding_screen.swipe_to_continue')}
							</Text>
